...
from dryad.university.services.multimodal_engine import MultimodalEngine
...
async def get_agent_assets(
    ...
    try:
        ...
        # Query assets
        from dryad.university.database.models_university import MediaAsset
...
async def get_agent_asset_details(
    ...
    try:
        ...
        from dryad.university.database.models_university import MultimodalInteraction
