...
from app.core.llm_config import get_llm, get_llm_info, LLMProvider, get_specialized_llm
from app.core.monitoring_integration import monitor_agent_workflow, monitoring_integration
...
Structure your response with clear sections and compelling content."""
    ...
    async def _create_agent_dialogue(
        ...
        try:
            ...
            from app.dryad.models.dialogue_message import DialogueMessage, MessageRole
