...
class AgentSubmission(Base):
    ...
    agent_sheet = Column(JSONB, nullable=False)
...
class CustomAgent(Base):
    ...
    client_id = Column(String(255), nullable=False, index=True)
    agent_configuration = Column(JSONB, nullable=False)
...
class AgentTemplate(Base):
    ...
    description = Column(Text, nullable=True)
    category = Column(String(100), nullable=True, index=True)
    template_sheet = Column(JSONB, nullable=False)
...
class AgentCapability(Base):
    ...
    description = Column(Text, nullable=True)
    category = Column(String(100), nullable=True, index=True)
    required_tools = Column(JSONB, nullable=True)
    required_llm_features = Column(JSONB, nullable=True)
    created_at = Column(DateTime, default=datetime.utcnow)
...
class AgentDefinition(BaseModel):
    ...
    name: str = Field(..., regex="^[a-zA-Z0-9_]+$", min_length=3, max_length=100)
