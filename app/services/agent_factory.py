...
class AgentValidator:
    ...
    def validate_agent_sheet(self, sheet: Dict[str, Any]) -> ValidationResult:
        ...
        if tools and self.db_session:
            tool_validation = self._validate_tools(tools, sheet)
    ...
    def _validate_tools(self, tools: List[Dict[str, Any]], sheet: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            for tool in tools:
                ...
                validation = self.db_session.query(tool_service.validate_tool_request(
                    tool_id=tool_id,
...
class AgentBuilder:
    ...
    def build_agent(self, sheet: Dict[str, Any]) -> CustomAgentInstance:
        ...
        agent = CustomAgentInstance(
            ...
            tools=self._create_tools(sheet.get("tools", []))
        )
...
class AgentRegistryManager:
    ...
    def register_agent(self, agent_config: Dict[str, Any]) -> str:
        ...
        agent_instance = self.builder.build_agent(agent_config)
