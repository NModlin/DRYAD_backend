"""
Automated Code Review Assistant Demonstration
...
This version runs automatically without user interaction.
"""
...
class AutomatedCodeReviewDemo:
    """Automated demonstration of Code Review Assistant."""
...
+     return jwt.encode(payload, SECRET_KEY, algorithm='HS256')
    ...
    def run(self):
        ...
        self.print_header("DRYAD.AI CODE REVIEW ASSISTANT - AUTOMATED DEMONSTRATION")
        ...
        print("\nStarting automated demonstration in 2 seconds...")
        time.sleep(2)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="DRYAD.AI Automated Code Review Demo")
    parser.add_argument(
        "--url",
    ...
    demo = AutomatedCodeReviewDemo(api_url=args.url)
    demo.run()
