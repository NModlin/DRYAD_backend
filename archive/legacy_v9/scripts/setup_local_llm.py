#!/usr/bin/env python3
"""
Enhanced Local LLM Setup Script for DRYAD.AI

This script helps you set up and configure local LLM providers for DRYAD.AI.
It provides automatic installation, configuration, and troubleshooting.
...
def setup_environment_file():
    ...
    env_content = """# DRYAD.AI Local LLM Configuration
...
def main():
    """Main setup function."""
    print_header("DRYAD.AI Local LLM Setup")
    
    print("This script will help you set up local LLM providers for DRYAD.AI.")
    print("You can run DRYAD.AI completely offline without API keys!")
    
    # Check current directory
    if not os.path.exists('app/main.py'):
        print_error("Please run this script from the DRYAD.AI Backend root directory")
        sys.exit(1)
    ...
    print("4. Start DRYAD.AI: uvicorn app.main:app --host 127.0.0.1 --port 8000")
