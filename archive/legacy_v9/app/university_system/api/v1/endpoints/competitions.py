...
from app.university_system.database.models_university import Competition, University, UniversityAgent, CompetitionParticipant
from app.university_system.services.competition_engine import CompetitionEngine
