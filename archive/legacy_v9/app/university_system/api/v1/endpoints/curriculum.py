...
from app.university_system.database.models_university import CurriculumPath, University, UniversityAgent
from app.university_system.services.curriculum_engine import CurriculumEngine
